      ...
      <div className="bg-sky-950 px-12 py-8 rounded-2xl">
        ...
        <div className="flex flex-col items-center">
          <p className="text-gray-400 text-center max-w-[640px] my-6 text-sm sm:text-base ">
            Nesta página você poderá ver alguns dos principais projetos que
            desenvolvi ao longo da faculdade e curso técnico. Sinta-se a vontade
            para explorar os projetos que estão sendo mostrados abaixo. Caso
            tenha interesse em ver outros projetos desenvolvidos por mim, acesse
            meu{' '}
